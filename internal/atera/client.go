...
// count returns totalItemCount without transferring any items. A tenant can hold
// tens of thousands of tickets, and itemsInPage is hard-capped at 50 by the API,
// so walking them just to count them can be over a thousand requests per poll.
// This is one.
